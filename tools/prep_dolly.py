...
def main():
    ...
    ap.add_argument('--max_train_samples', type=int, default=None, help='Optional cap on training examples')
    ap.add_argument('--max_val_samples', type=int, default=None, help='Optional cap on validation examples')
    args = ap.parse_args()
